...
def send_rich_email_alert(title, url, county, source):
    ...
    subject = f"🚨 NEW {source.upper()} LISTING: {county_formatted}"
    ...
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
          <span style="background-color: #2e7d32; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">{source}</span>
          ...
          <p style="font-size: 12px; color: #888888;">Automated alert from Farmland Monitor System.</p>
        </div>
      </body>
    </html>
    """
    ...
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
          ...
          <p style="font-size: 15px; color: #333;">Here is your weekly update on monitored farmland listings across Barron, Polk, Washburn, and Dunn counties.</p>
          ...
          <p style="font-size: 14px; color: #666;">The continuous monitoring script runs hourly to catch new properties across LandWatch, LandAndFarm, Land.com, and Whitetail Properties as soon as they hit the market.</p>
          <hr style="margin-top: 30px; border: None; border-top: 1px solid #eeeeee;">
...
def check_landwatch_for_county(county_slug, seen_properties):
    ...
    url = f"https://www.landwatch.com/wisconsin-land-for-sale/{county_slug}"
...
def check_landandfarm_for_county(county_slug, seen_properties):
    county_name = county_slug.replace('-', ' ').title()
    url = f"https://www.landandfarm.com/search/wisconsin/{county_slug}-land-for-sale/"
...
def main():
    ...
    print("🚀 Starting Farmland Monitor multi-site check...")
